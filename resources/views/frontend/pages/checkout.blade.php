        ...
        <div class="container">
            ...
            <form action="#" class="woocommerce-form-coupon" style="display:none;">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <input type="text" name="coupon_code" class="form-control" placeholder="Write your coupon code">
                        </div>
                        <div class="form-group">
            ...
            <!-- Main Checkout Form -->
            <form action="{{ route('checkout.process') }}" method="POST" class="woocommerce-checkout mt-40" id="checkout-form">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group">
                                <div class="custom-checkbox">
                                    <input type="checkbox" id="accountNewCreate" name="create_account" value="1"> 
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="shipping_address" id="shipping-fields" style="display:none;">
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    <input type="text" name="shipping_address" class="form-control" placeholder="Street Address">
                                </div>
                                <div class="col-12 form-group">
                                    <input type="text" name="shipping_city" class="form-control" placeholder="Town / City">
                                </div>
                                <div class="col-md-6 form-group">
                                    <input type="text" name="shipping_postcode" class="form-control" placeholder="Postcode / Zip">
                                </div>
                                <div class="col-md-6 form-group">
                                ...
                                <div class="col-12 form-group">
                                    <input type="tel" name="shipping_phone" class="form-control" placeholder="Phone Number">
                                </div>
                            </div>
                        </div>
                            ...
                            @forelse($cartItems as $item)
                                <tr class="cart_item">
                                    <td data-title="Product">
                                        <a class="cart-productimage" href="{{ route('product-details', $item['slug']) }}">
                                    ...
                                    <td data-title="Name">
                                        <a class="cart-productname" href="{{ route('product-details', $item['slug']) }}">
                                            {{ $item['name'] }}
                                        </a>
                                    </td>
                                    <td data-title="Price">
                            ...
                            <tr class="cart-subtotal">
                                ...
                                <td data-title="Subtotal" colspan="4">
                                    <span class="woocommerce-Price-amount amount">
                                        <bdi><span class="woocommerce-Price-currencySymbol">Rs.</span>{{ number_format($subtotal, 2) }}</bdi>
                                    </span>
                                </td>
                            </tr>
                    ...
                    <div class="woocommerce-checkout-payment">
                        <ul class="wc_payment_methods payment_methods methods">
                            ...
                            <li class="wc_payment_method payment_method_cod">
                                ...
                                <label for="payment_method_cod">Cash on Delivery 
                                    <img src="assets/img/product/credit-payment.png" alt="COD" style="height:20px;">
                                </label>
                        ...
                        <div class="form-group mt-3">
                            <div class="custom-checkbox">
                                ...
                                <label for="terms">I have read and agree to the <a href="" target="_blank">Terms & Conditions</a> *</label>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('.showlogin')?.addEventListener('click', function(e) {
        ...
        document.querySelector('.woocommerce-form-login').style.display = 
            document.querySelector('.woocommerce-form-login').style.display === 'none' ? 'block' : 'none';
    });
    ...
    document.querySelector('.showcoupon')?.addEventListener('click', function(e) {
        ...
        document.querySelector('.woocommerce-form-coupon').style.display = 
            document.querySelector('.woocommerce-form-coupon').style.display === 'none' ? 'block' : 'none';
    });
    ...
    document.getElementById('billing_country')?.addEventListener('change', function() {
        ...
        .then(data => {
            if (data.success) {
                document.getElementById('shipping-amount').textContent = 'Rs.' + parseFloat(data.shipping).toFixed(2);
                document.getElementById('order-total').textContent = parseFloat(data.total).toFixed(2);
                document.getElementById('btn-total').textContent = parseFloat(data.total).toFixed(2);
            }
        });
    });
