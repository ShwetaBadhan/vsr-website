        ...
        <div class="container">
          ...
          <form action="#" class="woocommerce-cart-form">
            <table class="cart_table mb-20">
              ...
              <tbody>
                <tr class="cart_item">
                  <td data-title="Product"><a class="cart-productimage" href="{{ route('products') }}"><img width="91" height="91" src="assets/img/product/product-1-1.png" alt="Image"></a></td>
                  <td data-title="Name"><a class="cart-productname" href="{{ route('products') }}">Coconut Oil Jar</a>
                  </td>
              ...
              <tfoot class="checkout-ordertable">
                <tr class="cart-subtotal">
                  <th>Subtotal</th>
                  <td data-title="Subtotal" colspan="4"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>200</bdi></span></td>
                </tr>
                ...
                <tr class="order-total">
                  <th>Total</th>
                  <td data-title="Total" colspan="4"><strong><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>200</bdi></span></strong>
                  </td>
                </tr>
              </tfoot>
            </table>
